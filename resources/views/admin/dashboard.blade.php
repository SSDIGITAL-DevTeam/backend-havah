...
<div id="content-page" class="content-page">
    <div class="container-fluid">
       <div class="row">
          ...
          <div class="col-lg-4">
             <div class="iq-card iq-card-block iq-card-stretch iq-card-height banner-image-block-bg position-relative" style="background: transparent url({{asset('html')}}/images/page-img/45.png) no-repeat scroll center bottom; background-size: contain; height: 440px; box-shadow: none;">
             </div>
          </div>
          <div class="col-lg-8">
             <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                ...
                <div class="iq-card-body">
                   <ul class="perfomer-lists m-0 p-0">
                      <li class="d-flex mb-4 align-items-center">
                         <div class="user-img img-fluid"><img src="{{asset('html')}}/images/page-img/29.png" alt="story-img" class="rounded avatar-40"></div>
                      ...
                      <li class="d-flex mb-4 align-items-center">
                         <div class="user-img img-fluid"><img src="{{asset('html')}}/images/page-img/30.png" alt="story-img" class="rounded avatar-40"></div>
                         <div class="media-support-info ml-3">
                            <h6>Behance</h6>
                      ...
                      <li class="d-flex mb-4 align-items-center">
                         <div class="user-img img-fluid"><img src="{{asset('html')}}/images/page-img/31.png" alt="story-img" class="rounded avatar-40"></div>
                         <div class="media-support-info ml-3">
                            <h6>Instagram</h6>
                      ...
                      <li class="d-flex mb-4 align-items-center">
                         <div class="user-img img-fluid"><img src="{{asset('html')}}/images/page-img/32.png" alt="story-img" class="rounded avatar-40"></div>
                         <div class="media-support-info ml-3">
                            <h6>Twitter</h6>
                      ...
                      <li class="d-flex mb-4 align-items-center">
                         <div class="user-img img-fluid"><img src="{{asset('html')}}/images/page-img/33.png" alt="story-img" class="rounded avatar-40"></div>
                         <div class="media-support-info ml-3">
                            <h6>Bootstrap</h6>
